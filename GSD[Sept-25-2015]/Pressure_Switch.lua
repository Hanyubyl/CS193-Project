...
function Pressure_Switch:initialize(world, object, settings)
	--local tile_offset = 8
	Entity.initialize(self,world, object.x+8, object.y+24, settings)
	print("Pressure_Switch created")
	self:visual_init(IMG, 0, 0, 16, 8,8)
	self:bump_init(self.world, 'Pressure_Switch', object.x, object.y, 16, 8)
	self:movement_init()
